var animation, async, dialog, fs, initJSON, initWrite, initWriteConfirm, install, log, maxmertkit, modifyers, pack, path, project, request, themes, widgets, wrench, _;
...
exports.init = function(options) {
  ...
  return async.series({
    ...
    if (err != null) {
      ...
      if (!(options.theme != null) && !(options.modifyer != null) && !(options.widget != null) && !options.animation) {
...
initJSON = function(options, callback) {
  ...
  return async.series({
    type: function(callback) {
      if (!options.theme && !options.modifyer && !options.widget && !options.animation) {
