...
exports.publish = function(options) {
  ...
  return async.series({
    ...
    test: function(callback) {
      var testHTML;
      testHTML = '';
      return fs.exists(path.join('.', 'test.html'), function(exist) {
        if (exist) {
    ...
    testCSS: function(callback) {
      var testCSS;
      testCSS = '';
      return fs.exists(path.join('.', 'index.css'), function(exist) {
        if (exist) {
    ...
    var deps, mods, ok, packFile, thms;
    if (err != null) {
